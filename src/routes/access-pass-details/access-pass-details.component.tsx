...
const AccessPassDetailsCard = (props: { data: CollectionType }) => {
  ...
  return (
    <div className={"access-pass-container"}>
      ...
      <div className={"access-pass-content"}>
        <div style={{ padding: "0 8px 8px" }}>
          <div className={"access-pass-info"}>
            <div
              className={"access-pass-logo"}
              style={{ backgroundImage: `url(${collectionImage})` }}
            />
            <div className={"access-pass-title"}>{title}</div>
            ...
            <div className={"access-pass-details"}>
              ...
              <div className={"access-pass-details-additional"}>
                {additionalDetails}
              </div>
            </div>
            <div
              className={"access-pass-details-button"}
    ...
    <div className={"access-pass-details-container"}>
      ...
      <div className={"access-pass-details-wrapper"}>
        ...
        <div style={{ marginTop: "16px" }}>
          ...
          {!isLoading && !accessPass && <div>Error on loading access pass</div>}
        </div>
      </div>
    </div>
  );
